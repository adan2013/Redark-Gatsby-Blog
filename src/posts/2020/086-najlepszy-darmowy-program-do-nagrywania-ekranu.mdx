...
W tej sekcji możesz zmienić typ oraz długość efektu aktywowanego podczas zmiany scen. Domyślnie wybrane jest "zanikanie" przez 300 milisekund, co powoduje, że podczas zmiany sceny, obraz zmieni się bardzo płynnie.

### Panel sterujący

Znajdziesz tutaj przyciski aktywujące najważniejsze funkcje OBS-a. Przejdziesz tutaj do ustawień aplikacji, rozpoczniesz transmisję oraz uruchomić nagrywanie ekranu.
...
To tylko jedna z wielu funkcji tej aplikacji. W przypadku tradycyjnego nagrywania ekranu taki proces wymagałby wynajęcia montażysty wideo, który dodałby te wszystkie funkcje i posklejał materiał razem. Ode mnie to wszystko. Mam nadzieję, że pokazałem Ci potęgę, jaka drzemie w tej aplikacji. Jeśli masz problem z jej konfiguracją, zapraszam do sekcji komentarzy pod tym artykułem i do usłyszenia.
