...
![project cost estimation](../2021/images/kosztorys_diy_arduino_dashboard.jpg)
...
And that's all for today. I’m sure it’s not the end of my adventure with electronics. I have many other ideas for new devices. Also, you can find an article about my second DIY project on this website (only in Polish). I hope you liked this article and the device 🙂.
